...
################################################################
# This is a generated script based on design: pynqzu
#
...
# <./pynqzu/pynqzu.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project pynqzu pynqzu -part xczu5eg-sfvc784-1-e
}
...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_ps_e_0_fclk0, and set properties
  set rst_ps_e_0_fclk0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_e_0_fclk0 ]

  # Create instance: rst_ps_e_0_fclk1, and set properties
  set rst_ps_e_0_fclk1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_e_0_fclk1 ]

  # Create instance: rst_ps_e_0_fclk2, and set properties
  set rst_ps_e_0_fclk2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_e_0_fclk2 ]

  # Create instance: rst_ps_e_0_fclk3, and set properties
  set rst_ps_e_0_fclk3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_e_0_fclk3 ]
  ...
  connect_bd_net -net ps_e_0_pl_clk0 [get_bd_pins ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps_e_0/pl_clk0] [get_bd_pins ps_e_0/saxi_lpd_aclk]
  connect_bd_net -net ps_e_0_pl_clk1 [get_bd_pins ps_e_0/pl_clk1] [get_bd_pins ps_e_0/saxihp0_fpd_aclk] [get_bd_pins ps_e_0/saxihp2_fpd_aclk]
  connect_bd_net -net ps_e_0_pl_clk0 [get_bd_pins ps_e_0/pl_clk0] [get_bd_pins rst_ps_e_0_fclk0/slowest_sync_clk]
  connect_bd_net -net ps_e_0_pl_clk1 [get_bd_pins ps_e_0/pl_clk1] [get_bd_pins rst_ps_e_0_fclk1/slowest_sync_clk]
  connect_bd_net -net ps_e_0_pl_clk2 [get_bd_pins ps_e_0/pl_clk2] [get_bd_pins rst_ps_e_0_fclk2/slowest_sync_clk]
  connect_bd_net -net ps_e_0_pl_clk3 [get_bd_pins ps_e_0/pl_clk3] [get_bd_pins rst_ps_e_0_fclk3/slowest_sync_clk]
  connect_bd_net -net ps_e_0_pl_resetn0 [get_bd_pins ps_e_0/pl_resetn0] [get_bd_pins rst_ps_e_0_fclk0/ext_reset_in] [get_bd_pins rst_ps_e_0_fclk1/ext_reset_in] [get_bd_pins rst_ps_e_0_fclk2/ext_reset_in] [get_bd_pins rst_ps_e_0_fclk3/ext_reset_in]
  ...
  set_property PFM_NAME {xilinx.com:xd:pynqzu:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK { \
    pl_clk0 {id "0" is_default "true" \
      proc_sys_reset "rst_ps_e_0_fclk0" status "fixed"} \
    pl_clk1 {id "1" is_default "false" \
      proc_sys_reset "rst_ps_e_0_fclk1" status "fixed"} \
    pl_clk2 {id "2" is_default "false" \
      proc_sys_reset "rst_ps_e_0_fclk2" status "fixed"} \
    pl_clk3 {id "3" is_default "false" \
      proc_sys_reset "rst_ps_e_0_fclk3" status "fixed"} \
    } [get_bd_cells /ps_e_0]
